...
<div class="menu_masonry" style="justify-content: center;">
  ...
  <div class="space"></div>
      <img src="https://livingarchitecturesystems.com/wp-content/uploads/3-1.jpg" class="hidpix">

            <div class="masonryBlog">
              <div class="col colText">
                <h1>Faire oeuvre avec les COCOCOCO</h1>

                <span class="regularText">
                  <p>
                    Olivain Porry, Samuel Bianchini, Florent Levillain. In. <i>Corps connectés</i>
                  </p>
                </span>
              </div>
            </div>

      <iframe src="pdfs/faireOeuvreAvecLesCOCOCOCO.pdf" class="pdfFrame"></iframe>
    </div>
